...
namespace parking.Views.Administration.Audit
{
    public partial class FrmLogBookApp : Form
    {
        ...
        private void getLogs(string searchFilter)
        {
            ...
            {
                DgvEmployees.Rows.Add(log.LOG_ID, log.LOG_DESCRIPTION, Convert.ToDateTime(log.INSERTED_AT).ToShortDateString());
            }
        }
        ...
        private void DgvEmployees_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvEmployees.Rows.Count > 0) { 
                int logId = Convert.ToInt32(DgvEmployees.CurrentRow.Cells[0].Value);
